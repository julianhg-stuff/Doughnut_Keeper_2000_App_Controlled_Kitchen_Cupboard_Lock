github/*************************************************************
 ...
 See the whole project build, (including the 3d printed parts) on youtube here:
 https://youtu.be/g2J9y92tR-8
 ...
 9)when making your circuit/breadboard:
      ...
      D3 on the D1 mini goes to:  the resistor before the BLUE LED +ve leg (the long leg)
      D4 on the D1 mini goes to:  the resistor before the RED LED  +ve leg (the long leg)
      GND on the D1 mini goes to: all devices GND leads (eg servo, optical switch and both LEDs (the LED's short legs)
      +5V (or +3V depending on your devices) on the D1 mini goes to: some devices +ve leads (eg servo and optical switch) 
          
      (note: the +ve for the LED's is supplied by pins D3 and D4, not the +5V pin)
